 ...
 * 		retrieved to gain the parameter value itself. Handlers for accessing external resources by a variety of different protocols are defined in the
 * 		      {@link org.javastro.ivoacore.uws.environment.parameter.protocol} package.
 */
